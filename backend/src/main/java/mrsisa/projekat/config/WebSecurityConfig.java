package mrsisa.projekat.config;

import mrsisa.projekat.bezbjednost.RestAuthenticationEntryPoint;
import mrsisa.projekat.bezbjednost.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private KorisnikService customUserDetailsService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/korisnici/potvrda-registracije").permitAll()
                .antMatchers("/api/v1/mail/slanjeMejla").permitAll()
                .antMatchers("/api/korisnici/potvrdaPrijave").permitAll()
