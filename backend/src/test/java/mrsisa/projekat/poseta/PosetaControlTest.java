...
@WithMockUser(username="marko1", roles= {"DERMATOLOG"})
@RunWith(SpringRunner.class)
@SpringBootTest
public class PosetaControlTest {
    private static final String URL_PREFIX = "api/v1/posete";
    ...
    public void testKreirajPonudu() throws Exception {
        ...
        this.mockMvc.perform(post(URL_PREFIX + "/proveriDostupnost").contentType(contentType).content(json))
